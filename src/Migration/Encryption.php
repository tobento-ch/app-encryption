...
namespace Tobento\App\Encryption\Migration;
 ...
 * Encryption
 */
class Encryption implements MigrationInterface
{
    /**
     * @var array The files.
     */
    ...
    public function install(): ActionsInterface
    {
        return new Actions(
            new FilesCopy(
                files: $this->files,
                type: 'config',
                description: 'Encryption config file.',
            ),
        );
    }
